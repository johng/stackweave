...
SUM="${STACKWEAVE_SOAK_DIR:-$HOME/runloom-soak}/forever_${WL}_SUMMARY.txt"
OUTDIR="${STACKWEAVE_SOAK_DIR:-$HOME/runloom-soak}/soak_${WL}_forever"
...
LEDGER="${STACKWEAVE_SOAK_DIR:-$HOME/runloom-soak}/forever_${WL}_ratchet_ledger.csv"
cd "$ROOT"
