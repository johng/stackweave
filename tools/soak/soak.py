...
Usage:
  ...
  # accelerated-life (max lifecycle turnover), with a tuning knob:
...
def main(argv):
    ...
    ap.add_argument("--env", action="append",
                    help="KEY=VAL passed to workers (STACKWEAVE_STACK_PARK_SWEEP_MS, "
                         "STACKWEAVE_IDLE_BACKOFF_MS, STACKWEAVE_SOAK_HUBS, ...)")
