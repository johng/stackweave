...
The M:N hub emits its wake-handshake transitions (STACKWEAVE_MNWAKE_TRACE=<path>:
...
TEMPLATE = '''\\* GENERATED by tools/mnwake_trace_conform.py from a real STACKWEAVE_MNWAKE_TRACE run.
...
def main():
    ...
    if not raw:
        print("empty trace (was STACKWEAVE_MNWAKE_TRACE set on an mn_run() offload?)")
        return 2
