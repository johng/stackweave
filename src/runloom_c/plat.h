 ...
 *
 * C99-strict.  Supports GCC 3+, Clang 3+, ICC, Watcom, Sun Studio.  No GNU
 * extensions in the public surface.
 *
 * Each block defines symbols downstream code can use without nested ifdefs.
 *   RUNLOOM_OS_LINUX / OS_MACOS / OS_BSD / OS_SOLARIS / OS_ANDROID
 *   RUNLOOM_ARCH_X86_64 / ARCH_X86 / ARCH_AARCH64 / ARCH_ARM / ARCH_RISCV
 *   RUNLOOM_CC_GCC / CC_CLANG / CC_ICC / CC_WATCOM / CC_SUN
 *   RUNLOOM_HAVE_FCONTEXT / HAVE_UCONTEXT / HAVE_EPOLL / HAVE_KQUEUE /
 *   HAVE_EVENT_PORTS
 */
 ...
 *   2. ucontext (RUNLOOM_HAVE_UCONTEXT)                       -- POSIX fallback.
 ...
 * exercised on Linux/BSD without exotic hardware. */
