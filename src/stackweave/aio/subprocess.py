...
class _SubprocessTransport(asyncio.SubprocessTransport):
    ...
    def _start_reaper(self):
        ...
        # Popen.wait().  This is the asyncio-bridge equivalent of stackweave.monkey's
        ...
        def reaper():
            try:
                ...
                try:
                    stackweave_c.netpoll_release_if_idle(pidfd)
    ...
    async def _connect_pipes(self):
        ...
        # order it; stackweave awaits _connect_pipes directly and it completes without
    ...
    def _process_exited(self, rc):
        ...
        # that as POLLHUP and disconnects the write pipe; stackweave's stdin transport
