"""StackweaveEventLoop -- asyncio.AbstractEventLoop assembled from the loop_* mixins.
...
class StackweaveEventLoop(_LoopCoreMixin, _LoopScheduleMixin, _LoopIOMixin,
                    _LoopNetMixin, _LoopSubprocessMixin, _LoopSignalMixin,
                    _LoopRunMixin, asyncio.AbstractEventLoop):
    """asyncio.AbstractEventLoop with everything the stackweave bridge needs.
