...
| **stackweave (8 hub)** | **3496** | **11 ms** | 271 ms | 526 ms | 29 |
...
a 100 ms CPU block waits). stackweave holds **p50 = 11 ms (37× better) and 7–10×
the throughput** — its 8 hubs absorb the CPU blocks on other cores.

## Single core, GIL'd 3.13 (incl. gevent; stackweave = 1 hub)
...
| stackweave (1 hub) | 708 | 281 ms | 677 ms | 1047 |
...
stackweave's advantage on the pathological tier is **multi-core (free-threading)**,
