...
def test_sched_offload_hub_never_pulls_unpinned_general_work():
    ...
    Was a gap (fixed: an offload hub pulls only entries pinned to it and its idle scan ignores unpinned work): the global run-queue pull accepts any unpinned entry (p1 ==
