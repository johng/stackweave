"""stackweave.sync.fiber() calls stackweave_c.fiber() directly with NO M:N dispatch
(unlike stackweave.fiber / stackweave.time._spawn / stackweave.context._spawn /
...
if not ran["v"]:
    print("BUG: fiber spawned via stackweave.sync.fiber never ran under M:N")
