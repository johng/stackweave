...
# TODO(stackweave): the linearizability battery fails on free-threaded 3.13t but
...
# races there -- not a stackweave or patched-interpreter bug.  Skipped on <3.14 only;
# remove when 3.13t support is dropped.
@pytest.mark.skipif(sys.version_info[:2] < (3, 14),
                    reason="TODO(stackweave): linz battery fails on 3.13t (unaudited free-threaded stdlib, gh-116738)")
@FT
