...
pytest collects this file).  The LIVE probe is gated behind STACKWEAVE_NET_TESTS=1
...
@pytest.mark.network
@pytest.mark.skipif(os.environ.get("STACKWEAVE_NET_TESTS") != "1",
                    reason="opt-in: set STACKWEAVE_NET_TESTS=1 to run live network probes")
